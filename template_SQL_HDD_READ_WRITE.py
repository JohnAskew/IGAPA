...
COLUMN_1  = 'HDD_READ_AVG' #ECOMMENDED_DB_RAM_SIZE_AVG' #DURATION_AVG' #RECOMMENDED_db_raw_SIZE_AVG' #STORAGE_SIZE_AVG
COLUMN_2  = 'HDD_READ_MAX' #DURATION_MAX' #RECOMMENDED_db_raw_SIZE_MAX' #STORAGE_SIZE_MAX
COLUMN_3  = 'HDD_WRITE_AVG' #CPU_AVG'
COLUMN_4  = 'HDD_WRITE_MAX' #CPU_MAX'
...
output_file("hdd.html", title = "HDD")
...
output_file("alt_view.html", title = "HDD Alt")
